...
| WP-05 — Company Intelligence V3 workflow                 | in_progress | V3 persistence, six narrow task contracts, guarded sequential Trigger orchestration, audited/resumable stages, and deterministic normalized draft compilation added; Migration 5 application and end-to-end fixtures remain. |
...
- Remaining before WP-05 completion: apply Migration 5, regenerate database types, and
  add end-to-end fixtures for success, resume, clarification, and failure paths.

## Next package entry point

Apply Migration 5 and regenerate types, then finish WP-05 with end-to-end workflow
