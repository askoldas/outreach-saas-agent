...
export const offers: Offer[] = [
  {
    ...
    lastUpdated: "Today",
    campaignCount: 2,
    problems: ["Supplier bottlenecks", "Prototype-to-production handoff", "Tolerance drift"],
  ...
  },
  {
    ...
    campaignCount: 1,
    problems: ["Manual approval chasing", "Late month-end accruals", "Duplicate invoice risk"],
    capabilities: ["Approval routing", "Exception queues", "ERP export"],
    customerValue: ["Cleaner handoffs", "Fewer late approvals", "Better status visibility"],
  ...
  },
  {
    ...
    campaignCount: 0,
    problems: ["Unplanned downtime", "Maintenance backlog", "Limited in-house specialists"],
    capabilities: ["On-site inspection", "Maintenance planning", "Emergency repair coordination"],
...
export const campaigns: Campaign[] = [
  {
    ...
    targetSegments: ["Equipment manufacturers", "Automation integrators", "Industrial OEMs"],
    progress: 68,
    leadCount: 42,
    awaitingReview: 9,
    status: "running",
    ...
    strategy: {
      terms: ["custom machined parts", "OEM component supplier", "industrial equipment manufacturer"],
      ...
      criteria: ["Manufactures complex equipment", "Likely recurring component needs", "Public contact route"],
  ...
  },
  {
    ...
    strategy: {
      terms: ["accounts payable workflow", "invoice approval bottlenecks", "finance operations team"],
      ...
      criteria: ["Finance team visible", "Operational complexity", "Evidence of approval workflows"],
  ...
  },
  {
    ...
    targetSegments: ["Food production plants", "Packaging facilities", "Light manufacturing"],
    progress: 18,
    leadCount: 11,
    awaitingReview: 3,
    status: "planning",
    ...
    strategy: {
      terms: ["production maintenance partner", "mechanical maintenance plant", "packaging line service"],
...
export const leads: Lead[] = [
  {
    ...
    qualification: [
      { label: "Industry fit", score: 92, confidence: "high", explanation: "Public pages focus on industrial automation equipment." },
      { label: "Need fit", score: 86, confidence: "medium", explanation: "Multiple product pages mention custom frames and machined subassemblies." },
      { label: "Company fit", score: 90, confidence: "high", explanation: "The company appears large enough for recurring supplier qualification." },
      { label: "Geography fit", score: 95, confidence: "high", explanation: "Located inside the selected Nordic target geography." },
      { label: "Commercial fit", score: 82, confidence: "medium", explanation: "Project-based manufacturing suggests periodic supplier evaluation." },
      { label: "Contactability", score: 64, confidence: "medium", explanation: "A general procurement inbox is listed, but no named buyer is confirmed." },
      { label: "Evidence quality", score: 84, confidence: "high", explanation: "Claims are backed by company pages retrieved this week." },
      { label: "Exclusion risk", score: 12, confidence: "medium", explanation: "No hard exclusion was found." },
    ],
    evidence: [
      {
        id: "ev-arclift-1",
  ...
  },
  {
    ...
    qualification: [
      { label: "Industry fit", score: 86, confidence: "high", explanation: "Services align with finance operations and advisory work." },
      { label: "Need fit", score: 78, confidence: "medium", explanation: "Workflow complexity is inferred from outsourced finance service pages." },
      { label: "Company fit", score: 80, confidence: "medium", explanation: "Size estimate suggests enough volume for process tooling." },
      { label: "Geography fit", score: 94, confidence: "high", explanation: "UK-based company in the selected market." },
      { label: "Commercial fit", score: 76, confidence: "medium", explanation: "Operational service delivery may benefit from approval visibility." },
      { label: "Contactability", score: 88, confidence: "high", explanation: "A department route and contact form are visible." },
      { label: "Evidence quality", score: 74, confidence: "medium", explanation: "Evidence is current but some operational detail is inferred." },
      { label: "Exclusion risk", score: 18, confidence: "medium", explanation: "No solo consultancy or marketplace-only signal found." },
    ],
    evidence: [
      {
        id: "ev-ledgerfield-1",
  ...
  },
  {
    ...
    description: "Produces packaged food products with multiple automated packaging lines.",
    fitScore: 73,
    confidence: "medium",
    contactability: "low",
    status: "researching",
    ...
    qualification: [
      { label: "Industry fit", score: 82, confidence: "medium", explanation: "Production operations match the intended maintenance segment." },
      { label: "Need fit", score: 70, confidence: "low", explanation: "Maintenance needs are plausible but not directly stated." },
      { label: "Company fit", score: 76, confidence: "medium", explanation: "Company size and facility type suggest relevant operations." },
      { label: "Geography fit", score: 88, confidence: "high", explanation: "Located in the target geography." },
      { label: "Commercial fit", score: 66, confidence: "low", explanation: "No public procurement or supplier process found yet." },
      { label: "Contactability", score: 42, confidence: "low", explanation: "Only a general contact form has been found." },
      { label: "Evidence quality", score: 62, confidence: "medium", explanation: "Evidence is company-level but not maintenance-specific." },
      { label: "Exclusion risk", score: 24, confidence: "medium", explanation: "No clear exclusion found." },
    ],
    evidence: [
      {
        id: "ev-packnorth-1",
