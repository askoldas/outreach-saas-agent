...
const fields = [
  ...
  ["capabilities", "Main capabilities", "Approval routing, inspection reports, service planning"],
  ["value", "Customer value", "Reduce delays, clarify ownership, improve handoffs"],
  ["buyers", "Likely buyer types", "Operations leaders, finance directors, procurement teams"],
  ["differentiators", "Differentiators", "Fast setup, documented process, specialist experience"],
      ...
      >
        <div className={styles.stack}>
          <div className={form.field}>
            ...
            <select className={form.select} id="offer-type" name="offerType" defaultValue="service">
            ...
            <span>This shapes the interface only; it is not sector-specific classification.</span>
          </div>
          ...
          {fields.map(([id, label, placeholder]) => (
            <div className={form.field} key={id}>
              ...
              {id === "offer-name" ? (
                <input className={form.input} id={id} name={id} placeholder={placeholder} />
              ) : (
                <textarea className={form.textarea} id={id} name={id} placeholder={placeholder} />
              )}
            </div>
          ))}
